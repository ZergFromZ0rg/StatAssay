    ...
    <div style={{ maxWidth: 1000, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14, flexWrap: "wrap", gap: 10 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
          <button type="button" style={utilBtn} onClick={() => downloadFile("statassay_report.md", data.report_markdown, "text/markdown")}>
            report.md
          </button>
          <button type="button" style={utilBtn} onClick={() => downloadFile("statassay_report.json", JSON.stringify(data, null, 2), "application/json")}>
            report.json
          </button>
